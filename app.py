...
features = ['Name_x', 'State', 'Type', 'BestTimeToVisit', 'Preferences', 'Gender','NumberOfChildren']
model = pickle.load(open('models/model.pkl','rb'))
label_encoders = pickle.load(open('models/label_encoders.pkl','rb'))

destinations_df = pd.read_csv("data/Expanded_Destinations.csv")
userhistory_df = pd.read_csv("data/Final_Updated_Expanded_UserHistory.csv")
